...
const PosPage = ({ onScan, postToBackend = true }) => {
    ...
    return (
        // <div
        //     className="relative  w-full h-full mx-auto p-4 mt-0 rounded shadow"
        //     onClick={() => { if (isFocusActive) inputRef.current?.focus() }}
        // >
        <div>

            <div style={{ display: "flex", alignItems: "center" }}>
                <img src={cashier} alt="Cashier" className="w-10 h-10 mr-2" />
                <h1 className="text-3xl font-bold mb-4 pt-4"> {t('pos.title')}</h1>
            </div>
